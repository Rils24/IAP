...
document.getElementById('close-modal-btn').addEventListener('click', closeModalFunction);
        ...
        $("#modal-body").html(`
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="flex justify-center">
              <img src="${movie.Poster}" class="rounded-lg shadow-md max-w-full h-auto" alt="${movie.Title}">
            </div>
            
            <div class="space-y-4">
              <div class="bg-gray-50 rounded-lg p-4">
                <h3 class="text-2xl font-bold text-gray-800 mb-4">${movie.Title}</h3>
